...
/**
 * The {@link DorisDynamicTableFactorySink} translates the catalog table to a table source.
 *
 ...
 */
public final class DorisDynamicTableFactorySink implements DynamicTableSinkFactory {
